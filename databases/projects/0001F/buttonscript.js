var jsunlockpsd = document.getElementById("htmlentertounlockjspass").textContent;
var hidejspsd = document.getElementById("htmlentertounlockjspass");
if (jsunlockpsd == "jh") {
    hidejspsd.style.display = "none";
    ...
    var changein = document.getElementById("htmlentertounlockjspass").textContent;
    var change = " ";
    change = "Incorrect Password: "+changein+". You will need to enter the correct password for this script to function"
    document.getElementById("htmlentertounlockjspass").innerHTML = change;
}
